...
### 1-2. location が固定マッピングにある場合のみ付与
...
- `_build_search_body(text_query: str, conditions: dict, max_results: int) -> dict`
